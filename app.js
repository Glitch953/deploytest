        ...
        <div class="elegant-card p-8 md:p-10 relative">
            ...
            <form id="loginForm" onsubmit="handleLogin(event)" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm text-sky-400 hover:text-teal-400 transition-colors relative group">
                        نسيت كلمة المرور؟
            ...
            <form id="registerForm" onsubmit="handleRegister(event)" class="space-y-6">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <span class="text-gray-400 text-sm">
                        أوافق على 
                        <a href="#" class="text-sky-400 hover:text-teal-400 transition-colors">الشروط والأحكام</a>
                        و
                        <a href="#" class="text-sky-400 hover:text-teal-400 transition-colors">سياسة الخصوصية</a>
                    </span>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="elegant-card p-6 sticky top-24">
                    ...
                    <!-- روابط سريعة -->
                    <div class="space-y-2">
                        <a href="#" onclick="accountPageLoader('personal')" class="flex items-center gap-3 p-3 rounded-xl transition-all duration-300" id="profile-personal-link">
                        ...
                        <a href="#" onclick="accountPageLoader('settings')" class="flex items-center gap-3 p-3 rounded-xl hover:bg-[var(--bg-card)] transition-all duration-300">
                        ...
                        <a href="#" onclick="accountPageLoader('registrations')" class="flex items-center gap-3 p-3 rounded-xl hover:bg-[var(--bg-card)] transition-all duration-300">
                            <div class="w-8 h-8 rounded-lg bg-[var(--bg-card)] flex items-center justify-center">
                                <i class="fas fa-clock text-gray-400"></i>
                            </div>
                            <span class="text-gray-400">تسجيلاتي</span>
                        </a>
                        <a href="#" onclick="accountPageLoader('certificates')" class="flex items-center gap-3 p-3 rounded-xl hover:bg-[var(--bg-card)] transition-all duration-300">
                            <div class="w-8 h-8 rounded-lg bg-[var(--bg-card)] flex items-center justify-center">
                                <i class="fas fa-certificate text-gray-400"></i>
                            </div>
                            <span class="text-gray-400">الشهادات</span>
                        </a>
                        <a href="#" onclick="loadPage('adminPanel')" class="admin-only hidden items-center gap-3 p-3 rounded-xl bg-purple-500/10 hover:bg-purple-500/20 transition-all duration-300">
